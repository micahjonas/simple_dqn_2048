...
envarg.add_argument("--screen_width", type=int, default=4, help="Screen width after resize.")
envarg.add_argument("--screen_height", type=int, default=4, help="Screen height after resize.")
