...
envarg.add_argument("--screen_width", type=int, default=6, help="Screen width after resize.")
envarg.add_argument("--screen_height", type=int, default=6, help="Screen height after resize.")
...
memarg.add_argument("--history_length", type=int, default=8, help="How many screen frames form a state.")
memarg.add_argument("--min_reward", type=float, default=0, help="Minimum reward.")
memarg.add_argument("--max_reward", type=float, default=131072, help="Maximum reward.")
...
antarg.add_argument("--random_starts", type=int, default=10, help="Perform max this number of dummy actions after game restart, to produce more random game dynamics.")
